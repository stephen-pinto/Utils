...
{
    public class PropertyMapper<T1, T2> : Dictionary<string, string>
        where T1 : class
        where T2 : class
    {
        ...
        public void Add<Type>(Expression<Func<Type>> expr1, Expression<Func<Type>> expr2)
        {
        ...
        public void Add<Type>(Expression<Func<T1, Type>> expr1, Expression<Func<T2, Type>> expr2)
        {
            Add(expr1, expr2, null);
        }

        public void Add<Type>(Expression<Func<T1, Type>> expr1, Expression<Func<T2, Type>> expr2, object defaultValue = null)
        {
            //If UnaryExpression then get operand of Body else get direct Body as MemberExpression
            var memExprssn1 = (MemberExpression)((expr1.Body is MemberExpression) ? expr1.Body : ((UnaryExpression)expr1.Body).Operand);
            var memExprssn2 = (MemberExpression)((expr2.Body is MemberExpression) ? expr2.Body : ((UnaryExpression)expr2.Body).Operand);
